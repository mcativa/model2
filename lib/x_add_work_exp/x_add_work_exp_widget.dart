...
class XAddWorkExpWidget extends StatefulWidget {
  const XAddWorkExpWidget({Key key}) : super(key: key);

  @override
  _XAddWorkExpWidgetState createState() => _XAddWorkExpWidgetState();
}

class _XAddWorkExpWidgetState extends State<XAddWorkExpWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final xAddWorkExpUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                      ...
                      child: StreamBuilder<List<WorkHistoryRecord>>(
                        stream: queryWorkHistoryRecord(
                          queryBuilder: (workHistoryRecord) => workHistoryRecord
                              .where('user',
                                  isEqualTo: xAddWorkExpUsersRecord.reference)
                              .orderBy('endDate'),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
