...
class XeventDetailsWidget extends StatefulWidget {
  const XeventDetailsWidget({
    Key key,
    this.likedJob,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _XeventDetailsWidgetState createState() => _XeventDetailsWidgetState();
}

class _XeventDetailsWidgetState extends State<XeventDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<JobPostsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<JobPostsRecord> xeventDetailsJobPostsRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final xeventDetailsJobPostsRecord =
            xeventDetailsJobPostsRecordList.isNotEmpty
                ? xeventDetailsJobPostsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          body: Column(
                                              ...
                                              child: ToggleIcon(
                                                onPressed: () async {
                                                  final jobPostsUpdateData =
                                                    ...
                                                    likedPost:
                                                        !xeventDetailsJobPostsRecord
                                                            .likedPost,
                                                  );
                                                  await xeventDetailsJobPostsRecord
                                                      .reference
                                                      .update(
                                                          jobPostsUpdateData);
                                                },
