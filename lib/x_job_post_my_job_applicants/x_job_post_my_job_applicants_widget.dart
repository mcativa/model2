...
class XJobPostMyJobApplicantsWidget extends StatefulWidget {
  const XJobPostMyJobApplicantsWidget({
    Key key,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _XJobPostMyJobApplicantsWidgetState createState() =>
      _XJobPostMyJobApplicantsWidgetState();
}

class _XJobPostMyJobApplicantsWidgetState
    extends State<XJobPostMyJobApplicantsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<JobPostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final xJobPostMyJobApplicantsJobPostsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                            ...
                            children: [
                              Image.network(
                                valueOrDefault<String>(
                                  xJobPostMyJobApplicantsJobPostsRecord
                                      .photoHero,
