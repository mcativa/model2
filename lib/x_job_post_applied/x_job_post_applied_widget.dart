...
class XJobPostAppliedWidget extends StatefulWidget {
  const XJobPostAppliedWidget({
    Key key,
    this.application,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _XJobPostAppliedWidgetState createState() => _XJobPostAppliedWidgetState();
}

class _XJobPostAppliedWidgetState extends State<XJobPostAppliedWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<JobPostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final xJobPostAppliedJobPostsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                  ...
                  children: [
                      ...
                      children: [
                        Image.network(
                          valueOrDefault<String>(
                            xJobPostAppliedJobPostsRecord.photoHero,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              xJobPostAppliedJobPostsRecord.jobName,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            xJobPostAppliedJobPostsRecord.jobCompany,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              xJobPostAppliedJobPostsRecord.jobDescription,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              xJobPostAppliedJobPostsRecord.jobRequirements,
                              style: FlutterFlowTheme.bodyText1,
                            ),
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              xJobPostAppliedJobPostsRecord.jobPreferredSkills,
                              style: FlutterFlowTheme.bodyText1,
                            ),
                          ),
                        ],
