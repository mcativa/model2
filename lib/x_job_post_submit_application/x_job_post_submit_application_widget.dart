...
class XJobPostSubmitApplicationWidget extends StatefulWidget {
  const XJobPostSubmitApplicationWidget({
    Key key,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _XJobPostSubmitApplicationWidgetState createState() =>
      _XJobPostSubmitApplicationWidgetState();
}

class _XJobPostSubmitApplicationWidgetState
    extends State<XJobPostSubmitApplicationWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<JobPostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final xJobPostSubmitApplicationJobPostsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          body: Column(
                              ...
                              children: [
                                Image.network(
                                  valueOrDefault<String>(
                                    xJobPostSubmitApplicationJobPostsRecord
                                        .photoHero,
